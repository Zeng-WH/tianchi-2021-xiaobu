...
import time
import json
from trick.optimizer import Lookahead
...
def main():
    ...
    if args.do_train:
        ...
        #train_examples = np.load('/home/ypd-19-2/abu/beyond_baseline/10-fold/0/train.npy', allow_pickle=True)
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        #eval_examples = np.load('/home/ypd-19-2/abu/beyond_baseline/10-fold/0/dev.npy', allow_pickle=True)
